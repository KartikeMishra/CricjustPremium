// lib/screen/all_tournaments_screen.dart
...
class _AllTournamentsScreenState extends State<AllTournamentsScreen> {
  ...
  // Fetch tournaments using public API (no token required)
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              t.tournamentName,
                              style:
                              AppTextStyles.matchTitle.copyWith(
                                color: isDark
                                    ? Colors.white
                                    : Colors.black87,
                              ),
