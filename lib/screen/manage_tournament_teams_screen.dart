...
class _ManageTournamentTeamsScreenState extends State<ManageTournamentTeamsScreen> {
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, i) {
                    ...
                    return Card(
                      ...
                      child: ListTile(
                        leading: (t.teamLogo != null && t.teamLogo!.isNotEmpty)
  ...
  Future<void> _deleteTeam(TeamModel t) async {
    if (_token == null || t.teamId == null) return;
...
class _EditTeamBottomSheetState extends State<EditTeamBottomSheet> {
  ...
  void initState() {
    ...
    if (widget.team.teamPlayers != null) {
      _selectedPlayerIds.addAll(widget.team.teamPlayers!.map((e) => e as int));
