      ...
      child: Row(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: (isDark ? Colors.white12 : AppColors.primary.withOpacity(.12)),
              borderRadius: BorderRadius.circular(14),
            ),
    ...
    return ClipRRect(
      ...
      child: BackdropFilter(
        ...
        child: Container(
          padding: const EdgeInsets.all(16),
          decoration: BoxDecoration(
            color: isDark ? const Color(0x1AFFFFFF) : Colors.white.withOpacity(.82),
            borderRadius: BorderRadius.circular(18),
            border: Border.all(
            ...
            boxShadow: [
              BoxShadow(
                color: Colors.black.withOpacity(isDark ? .4 : .06),
                blurRadius: 20,
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: Theme.of(context).brightness == Brightness.dark
            ? const Color(0xFF0F1012).withOpacity(.96)
            : Colors.white.withOpacity(.96),
        border: Border(top: BorderSide(color: Colors.black12.withOpacity(.08))),
        boxShadow: [
          BoxShadow(
