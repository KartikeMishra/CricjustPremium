...
class TournamentMatchesSection extends StatefulWidget {
  ...
  @override
  State<TournamentMatchesSection> createState() => _TournamentMatchesSectionState();
}

class _TournamentMatchesSectionState extends State<TournamentMatchesSection> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        ...
        final dt = DateTime.tryParse('${m.matchDate} ${m.matchTime}') ?? DateTime.now();
