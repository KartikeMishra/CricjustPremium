...
class PlayerPublicInfoTab extends StatefulWidget {
  final int playerId;
  const PlayerPublicInfoTab({Key? key, required this.playerId}) : super(key: key);
...
class _PlayerPublicInfoTabState extends State<PlayerPublicInfoTab> {
                    ...
                    child: Column(
                      children: [
                        ...
                        if (player.batterType != null) ...[
                          const SizedBox(height: 4),
                          Text(player.batterType!, style: Theme.of(context).textTheme.bodySmall),
                        ],
                        if (player.bowlerType != null) ...[
                          const SizedBox(height: 4),
                          Text(player.bowlerType!, style: Theme.of(context).textTheme.bodySmall),
                        ],
                      ],
                    ),
                  ),
  ...
  Widget _buildCareerCard(BuildContext context,
      {required String title, required IconData icon, required Map<String, dynamic> rows}) {
    return Card(
