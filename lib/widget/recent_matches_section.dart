...
// ✅ No logic changed. Visual polish + overflow safety + active-card scale.
...
class _RecentMatchesSectionState extends State<RecentMatchesSection> {
  ...
  Widget build(BuildContext context) {
    ...
    // Slightly taller so two team rows + result never overflow
                ...
                child: AnimatedScale(
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: isDark
                          ? [BoxShadow(color: Colors.black.withOpacity(0.35), blurRadius: 14, offset: const Offset(0, 8))]
                          : [BoxShadow(color: Colors.blue.withOpacity(0.10), blurRadius: 12, offset: const Offset(0, 8))],
                    ),
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(18),
                      child: Stack(
                        children: [
                          ...
                          // 🏏 watermark bat/ball (very subtle)
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 8),
                                  // Result area is flexible to prevent overflow with long text
